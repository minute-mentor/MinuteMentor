    ...
    <MainContainer>
      ...
      <Card>
        <div class="row">
            ...
            <h2 class="text-white" style={{marginLeft:"28%"}}>Status Calender</h2>
            ...
            <div class="col-lg-6 col-sm-12">
            <h2 class="text-white" style={{marginLeft:"25%"}}>Attendance Data</h2>
                <AttList uname={uname}/>
